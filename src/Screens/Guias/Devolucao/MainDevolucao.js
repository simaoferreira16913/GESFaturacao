...
export default function MainDevolucao({navigation}) {
  ...
  return (     
    ...
    <Text style={styles.paddingBottom}>Menu Guia Devolução</Text>
  <View style={styles.container}>
    <TouchableOpacity
      style={[styles.menuButton, styles.shadow]}
      onPress={() => navigation.navigate("GesFaturação - Criar Guia Devolução")}>
      <Text style={styles.menuText}>Criar Guia Devolução</Text>
    </TouchableOpacity>
    <TouchableOpacity
      style={[styles.menuButton, styles.shadow]}
